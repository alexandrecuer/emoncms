<!--All Emoncms code is released under the GNU Affero General Public License.
    ...
    //******************************************************************************************************
    //31/10/2018 - Alexandre CUER - psychometric diagram implementation on the basis of multigraphs
-->
...
<div class = "container-fluid">             
    ...
    <div id="psychograph" style="width:100%; height:400px; position: relative;"></div>
    <button class='btn graph-nav' id='calc'>calculate %</button>
    <button class='btn graph-nav' id='clear'>clear</button>
    <div id='psychotext' style='width:100%; height:200px; position: relative;'>do change</div>
...
<script id="source" language="javascript" type="text/javascript">
    ...
    function clear_confort_stats() {
        $("#psychotext").replaceWith("<div id='psychotext' style='width:100%; height:200px; position: relative;'></div>");
    }
    ...
    function calc_confort_stats() {
        ...
        var text = "<div id='psychotext' style='width:100%; height:200px; position: relative;'>";
    ...
    function vis_feed_data() {
        ...
        var plot = $.plot($("#psychograph"), plotdata, {
                canvas: true,
